        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!company.getText().toString().equals("") && !company.getText().toString().equals("Default_Preset"))
                {
                    ...
                    for(int j=0; j<5; j++) {
                        if(c[j].getText().toString().equals("") || c[j].getText().toString().equals("0") || d[j].getText().toString().equals("") || d[j].getText().toString().equals("0"))
                        {
                            noNull=false;
                        }
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.ConfigConfirm:
                ...
                {
                    Toast.makeText(Configuration.this,"Changes Not Saved",Toast.LENGTH_LONG).show();
                }
                startActivity(i);
                return true;
            default:
